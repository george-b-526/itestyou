<?php
	...
	$body = '
		...
		<form action="https://www.itestyou.com/learn/Content:Register?returnto='.urlencode($returnto).'" method="post" name="userlogin">
		...
		<hr style="margin: 8px; margin-bottom: 32px;"/>

		<p>Already have an account? Please <a href="http://www.itestyou.com/learn/Content:Login"><b>login</b></a> now!</p>		
