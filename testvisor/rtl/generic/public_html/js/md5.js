...
function ItyStopwatch (elementId){
  ...
  this.getElapsed = function() {
	...
	elapsed %= this.onemin;
	var secs = parseInt(Math.round(elapsed / this.onesec));
  ...
  this.onTick = function() {
    ...
    var tag = document.getElementById(this.elementId);
	if (tag){
		tag.innerHTML = "&nbsp;&nbsp;" + zpad(e.minutes,2) + ":" + zpad(e.seconds,2) + "&nbsp;&nbsp;";
	}
  }
